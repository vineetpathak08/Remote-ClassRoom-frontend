...
const Signup = () => {
    ...
    return (
        <div className='relative w-full h-screen md:h-[760px] bg-sky-100 overflow-hidden'>
                    ...
                    <div className='w-full max-w-md space-y-6'>
                        ...
                        <Card className="w-full max-w-sm">
                            <CardHeader className='space-y-1'>
                                <CardTitle className='text-2xl text-center text-sky-600'>Sign up</CardTitle>
                                <CardDescription className='text-center'>
                                    Create your account to get started with Remote ClassRoom
                                </CardDescription>
                            </CardHeader>
                            <CardContent>                   
                            ...
                            <CardFooter className="flex-col gap-2">
                                <Button onClick={handleSubmit} type="submit" className="w-full bg-sky-600 hover:bg-sky-500">
                                    {
                                        isLoading ? (
                                        <>
